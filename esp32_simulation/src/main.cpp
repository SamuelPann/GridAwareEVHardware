// code for esp32 intended for home networks (not on WPA2)

// bluetooth, simulating algorithm, tiny display, sending data to server on home network,
...
void connectToWiFi() {
  ...
  WiFi.begin(stored_wifi, stored_password);
